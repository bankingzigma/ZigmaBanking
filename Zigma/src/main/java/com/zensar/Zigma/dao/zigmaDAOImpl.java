...
private Session session;
	...
	public void update(AdminLogin adminlogin) {
		...
		tx.commit();
		System.out.println("AdminLogin details updated");
	}
	public void delete(AdminLogin adminlogin) {
		...
		tx.commit();
		System.out.println("AdminLogin details deleted");
	}
	public AdminLogin getByAdminId(int adminId) {
		// TODO Auto-generated method stub
		return session.get(AdminLogin.class, adminId);
	}
	public List<AdminLogin> getAllAdmins() {
		// TODO Auto-generated method stub
		Query query=session.createQuery("from AdminLogin");//Hibernate Query Language
		return query.getResultList();
	}
	public void insert(CustomerLogin customerlogin) {
		...
		tx.commit();
		System.out.println("CustomerLogin details inserted");
	}
	public void update(CustomerLogin customerlogin) {
		...
		tx.commit();
		System.out.println("CustomerLogin details updated");
	}
	public void delete(CustomerLogin customerlogin) {
		// TODO Auto-generated method stub
		Transaction tx=session.beginTransaction();
		session.delete(customerlogin);
		tx.commit();
		System.out.println("CustomerLogin details deleted");
	}
	public CustomerLogin getByCRN(int crn) {
		// TODO Auto-generated method stub
		return session.get(CustomerLogin.class, crn);
	}
	public List<CustomerLogin> getAllCustomers() {
		// TODO Auto-generated method stub
		Query query=session.createQuery("from CustomerLogin");//Hibernate Query Language
		return query.getResultList();
	}
